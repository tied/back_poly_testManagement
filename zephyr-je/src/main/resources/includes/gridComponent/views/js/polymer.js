  ...
  Polymer.PropertyAccessors = Polymer.dedupingMixin(function (superClass) {
    ...
    var PropertyAccessors = function (_superClass) {
      ...
      function PropertyAccessors() {
        ...
        /** @type {boolean} */
        var _this2 = _possibleConstructorReturn(this, (PropertyAccessors.__proto__ || Object.getPrototypeOf(PropertyAccessors)).call(this));
  ...
  Polymer.PropertyEffects = Polymer.dedupingMixin(function (superClass) {
    ...
    var PropertyEffects = function (_propertyEffectsBase) {
      ...
      function PropertyEffects() {
        ...
        /** @type {boolean} */
        var _this5 = _possibleConstructorReturn(this, (PropertyEffects.__proto__ || Object.getPrototypeOf(PropertyEffects)).call(this));
  ...
  Polymer.ElementMixin = Polymer.dedupingMixin(function (base) {
    ...
    var PolymerElement = function (_polymerElementBase) {
      ...
      function PolymerElement() {
        ...
        var _this6 = _possibleConstructorReturn(this, (PolymerElement.__proto__ || Object.getPrototypeOf(PolymerElement)).call(this));
...
(function () {
  ...
  var Gestures = {
    ...
    _handleNative: function _handleNative(ev) {
      ...
      for (var _i3 = 0, _r; _i3 < Gestures.recognizers.length; _i3++) {
        _r = Gestures.recognizers[_i3];
...
(function () {
  ...
  Polymer.GestureEventListeners = Polymer.dedupingMixin(function (superClass) {
     ...
     */
    var GestureEventListeners = function (_superClass3) {
  ...
  Polymer.DirMixin = Polymer.dedupingMixin(function (base) {
    ...
    var Dir = function (_elementBase) {
      ...
      function Dir() {
        ...
        /** @type {boolean} */
        var _this9 = _possibleConstructorReturn(this, (Dir.__proto__ || Object.getPrototypeOf(Dir)).call(this));

        _this9.__autoDirOptOut = false;
        return _this9;
      }
...
(function () {
  ...
  function calcEditDistances(current, currentStart, currentEnd, old, oldStart, oldEnd) {
    ...
    for (var j = 0; j < columnCount; j++) {
      distances[0][j] = j;
    }for (var _i4 = 1; _i4 < rowCount; _i4++) {
      for (var _j = 1; _j < columnCount; _j++) {
        if (equals(current[currentStart + _j - 1], old[oldStart + _i4 - 1])) distances[_i4][_j] = distances[_i4 - 1][_j - 1];else {
          var north = distances[_i4 - 1][_j] + 1;
          var west = distances[_i4][_j - 1] + 1;
          distances[_i4][_j] = north < west ? north : west;
        }
      }
    }
  ...
  var FlattenedNodesObserver = function () {
    ...
    _createClass(FlattenedNodesObserver, [{
        ...
        if (isSlot(this._target)) {
          ...
          if (window.ShadyDOM) {
            this._shadyChildrenObserver = ShadyDOM.observeChildren(this._target, function (mutations) {
              _this11._processMutations(mutations);
            });
          } else {
      ...
      value: function flush() {
        ...
        // process adds
        for (var _i5 = 0, _s; _i5 < splices.length && (_s = splices[_i5]); _i5++) {
          for (var _j2 = _s.index; _j2 < _s.index + _s.addedCount; _j2++) {
  ...
  Polymer.LegacyElementMixin = Polymer.dedupingMixin(function (base) {
    ...
    var LegacyElement = function (_legacyElementBase) {
      ...
      function LegacyElement() {
        ...
        var _this13 = _possibleConstructorReturn(this, (LegacyElement.__proto__ || Object.getPrototypeOf(LegacyElement)).call(this));

        _this13.root = _this13;
        /** @type {boolean} */
        _this13.isAttached;
        /** @type {WeakMap<!Element, !Object<string, !Function>>} */
        _this13.__boundListeners;
...
(function () {
  ...
  Polymer.MutableData = Polymer.dedupingMixin(function (superClass) {
     ...
     */
    var MutableData = function (_superClass4) {
      _inherits(MutableData, _superClass4);
  ...
  Polymer.OptionalMutableData = Polymer.dedupingMixin(function (superClass) {
     ...
     */
    var OptionalMutableData = function (_superClass5) {
      _inherits(OptionalMutableData, _superClass5);
...
(function () {
  ...
  var TemplateInstanceBase = function (_base) {
    ...
    function TemplateInstanceBase(props) {
      ...
      var _this17 = _possibleConstructorReturn(this, (TemplateInstanceBase.__proto__ || Object.getPrototypeOf(TemplateInstanceBase)).call(this));

      _this17._configureProperties(props);
      _this17.root = _this17._stampTemplate(_this17.__dataHost);
      // Save list of stamped children
      var children = _this17.children = [];
      for (var n = _this17.root.firstChild; n; n = n.nextSibling) {
        children.push(n);
        n.__templatizeInstance = _this17;
      }
      if (_this17.__templatizeOwner.__hideTemplateChildren__) {
        _this17._showHideChildren(true);
      }
      // Flush props only when props are passed if instance props exist
      // or when there isn't instance props.
      var options = _this17.__templatizeOptions;
      if (props && options.instanceProps || !options.instanceProps) {
        _this17._enableProperties();
      }
      return _this17;
    }
    /**
...
(function () {
  ...
  var DomBind = function (_domBindBase) {
    ...
    function DomBind() {
      ...
      var _this22 = _possibleConstructorReturn(this, (DomBind.__proto__ || Object.getPrototypeOf(DomBind)).call(this));

      _this22.root = null;
      _this22.$ = null;
      _this22.__children = null;
      return _this22;
    }
        ...
        if (!this.__children) {
          ...
          if (!template) {
            ...
            var observer = new MutationObserver(function () {
              template = /** @type {HTMLTemplateElement} */_this23.querySelector('template');
              if (template) {
                observer.disconnect();
                _this23.render();
              } else {
...
(function () {
  ...
  var DomRepeat = function (_domRepeatBase) {
    ...
    function DomRepeat() {
      ...
      var _this24 = _possibleConstructorReturn(this, (DomRepeat.__proto__ || Object.getPrototypeOf(DomRepeat)).call(this));

      _this24.__instances = [];
      _this24.__limit = Infinity;
      _this24.__pool = [];
      _this24.__renderDebouncer = null;
      _this24.__itemsIdxToInstIdx = {};
      _this24.__chunkCount = null;
      _this24.__lastChunkTime = null;
      _this24.__sortFn = null;
      _this24.__filterFn = null;
      _this24.__observePaths = null;
      _this24.__ctor = null;
      _this24.__isDetached = true;
      _this24.template = null;
      return _this24;
    }
      ...
      value: function __ensureTemplatized() {
        ...
        if (!this.__ctor) {
          ...
          if (!template) {
            // // Wait until childList changes and template should be there by then
            var observer = new MutationObserver(function () {
              if (_this25.querySelector('template')) {
                observer.disconnect();
                _this25.__render();
              } else {
      ...
      value: function __applyFullRefresh() {
        ...
        if (this.__filterFn) {
          isntIdxToItemsIdx = isntIdxToItemsIdx.filter(function (i, idx, array) {
            return _this27.__filterFn(items[i], idx, array);
          });
        }
        // Apply user sort
        if (this.__sortFn) {
          isntIdxToItemsIdx.sort(function (a, b) {
            return _this27.__sortFn(items[a], items[b]);
          });
        }
        ...
        for (var _i6 = this.__instances.length - 1; _i6 >= instIdx; _i6--) {
          this.__detachAndRemoveInstance(_i6);
        }
      }
    }, {
...
(function () {
  ...
  var DomIf = function (_Polymer$Element) {
    ...
    function DomIf() {
      ...
      var _this28 = _possibleConstructorReturn(this, (DomIf.__proto__ || Object.getPrototypeOf(DomIf)).call(this));

      _this28.__renderDebouncer = null;
      _this28.__invalidProps = null;
      _this28.__instance = null;
      _this28._lastIf = false;
      _this28.__ctor = null;
      return _this28;
    }
        ...
        if (parentNode) {
          if (!this.__ctor) {
            ...
            if (!template) {
              // Wait until childList changes and template should be there by then
              var observer = new MutationObserver(function () {
                if (_this30.querySelector('template')) {
                  observer.disconnect();
                  _this30.__render();
                } else {
...
(function () {
  ...
  var ArraySelectorMixin = Polymer.dedupingMixin(function (superClass) {
    ...
    var ArraySelectorMixin = function (_elementBase2) {
      _inherits(ArraySelectorMixin, _elementBase2);
      ...
      function ArraySelectorMixin() {
        ...
        var _this31 = _possibleConstructorReturn(this, (ArraySelectorMixin.__proto__ || Object.getPrototypeOf(ArraySelectorMixin)).call(this));

        _this31.__lastItems = null;
        _this31.__lastMulti = null;
        _this31.__selectedMap = null;
        return _this31;
      }
        ...
        value: function __applySplices(splices) {
          ...
          var _loop4 = function _loop4(i) {
            ...
            for (var j = 0; j < s.addedCount; j++) {
              var idx = s.index + j;
              if (selected.has(_this32.items[idx])) {
                selected.set(_this32.items[idx], idx);
              }
            }
          };
          ...
          selected.forEach(function (idx, item) {
            if (idx < 0) {
              if (_this32.multi) {
                _this32.splice('selected', sidx, 1);
              } else {
                _this32.selected = _this32.selectedItem = null;
              }
        ...
        value: function __updateLinks() {
          ...
          if (this.multi) {
            ...
            this.__selectedMap.forEach(function (idx) {
              if (idx >= 0) {
                _this33.linkPaths('items.' + idx, 'selected.' + sidx++);
              }
            });
          } else {
            this.__selectedMap.forEach(function (idx) {
              _this33.linkPaths('selected', 'items.' + idx);
              _this33.linkPaths('selectedItem', 'items.' + idx);
            });
          }
        }
...
(function () {
  ...
  var CustomStyle = function (_HTMLElement2) {
    _inherits(CustomStyle, _HTMLElement2);

    function CustomStyle() {
      _classCallCheck(this, CustomStyle);

      var _this36 = _possibleConstructorReturn(this, (CustomStyle.__proto__ || Object.getPrototypeOf(CustomStyle)).call(this));

      _this36._style = null;
      CustomStyleInterface.addCustomStyle(_this36);
      return _this36;
    }
    /**
