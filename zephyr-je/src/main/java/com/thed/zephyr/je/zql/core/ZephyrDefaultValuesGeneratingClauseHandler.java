 ...
 * @since v3.1.3
 */
public class ZephyrDefaultValuesGeneratingClauseHandler implements ClauseHandler, ValueGeneratingClauseHandler
{
    ...
    public ZephyrDefaultValuesGeneratingClauseHandler(final ClauseInformation clauseInformation, final ClauseQueryFactory factory, final ClauseValidator validator,
    ...
    public boolean equals(final Object o)
    {
        ...
        final ZephyrDefaultValuesGeneratingClauseHandler that = (ZephyrDefaultValuesGeneratingClauseHandler) o;
