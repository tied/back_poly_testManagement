...
public class EditZephyrExecutionStatuses extends JiraWebActionSupport {
	...
	public EditZephyrExecutionStatuses(ZephyrLicenseManager zLicenseManager){
	...
	protected String doExecute() throws Exception
    {
    	...
    	log.debug("Execution status with id=" + getId() + " got edited");
     	...
     	Map<Integer, ExecutionStatus> execStatusMap = JiraUtil.getExecutionStatuses();
     	ExecutionStatus updateExecStatusObj = execStatusMap.get(intObj);
    	execStatusMap.remove(intObj);
    	...
    	execStatusMap.put(intObj, newExecStatus);
