...
public class ImportJobHistory implements Serializable {
	 ...
	 * @param comments
	 */
	public ImportJobHistory(Date actionDate, String comments) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final ImportJobHistory other = (ImportJobHistory) obj;
		if (actionDate == null) {
