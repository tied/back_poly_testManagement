...
public interface QueryCache
{
     ...
     * for the {@link User} zqlClauseName pair.
     *
     * @param searcher the user who is performing the search
     * @param zqlClauseName the jQLClauseName for which to find the result for; cannot be null.
     * @return the collection of {@link com.atlassian.jira.jql.ClauseHandler}s registered
     * for the {@link User} zqlClauseName pair.
     */
    Collection<ClauseHandler> getClauseHandlers(ApplicationUser searcher,  String zqlClauseName);
     ...
     *
     * @param searcher the user who is performing the search
     * @param zqlClauseName the jQLClauseName for which to store the result under; cannot be null.
     ...
     */
    void setClauseHandlers(ApplicationUser searcher,  String zqlClauseName, Collection<ClauseHandler> clauseHandlers);
