 ...
 *
 */
public class FolderNameResolver implements NameResolver<Folder> {
	
	private final FolderManager folderManager;
	
    public FolderNameResolver(FolderManager folderManager) {
    ...
    public List<String> getIdsFromName(final String name) {
        ...
        names.add(name);
		List<Folder> allFolders = folderManager.getValuesByKey("NAME", names);
