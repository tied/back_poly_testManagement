...
public class ViewZephyrExecutionStatuses extends JiraWebActionSupport {
    ...
    public ViewZephyrExecutionStatuses(ZephyrLicenseManager zLicenseManager){
    ...
    public String doAddExecutionStatus() throws Exception
    {
    	...
    	List<Integer>statusIds = new ArrayList<Integer>(execStatusMap.keySet());    
    	...
    	execStatusMap.put(newStatusID, newExecStatus);
        ...
        else
        {
			...
			setStatusColor(null);
			/**
			 * ADDED THIS FOR ZFJ-4447 FIX. REDIRECTING IT TO THE SAME PAGG IN ORDER TO
			 * PREVENT THE FORM RESUBMIT ON RELOADING THE PAGE
			 */
            return getRedirect("ViewZephyrExecutionStatuses!default.jspa");
        }
	...
	public Collection<ExecutionStatus> getExecutionStatusList(){
		return JiraUtil.getExecutionStatusList();
	}
}
