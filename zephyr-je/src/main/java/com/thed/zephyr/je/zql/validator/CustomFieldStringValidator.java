...
public class CustomFieldStringValidator  implements ClauseValidator {
	...
	private final SupportedOperatorsValidator supportedOperatorsValidator;
	 ...
	 public CustomFieldStringValidator(JqlOperandResolver operandResolver, I18nHelper.BeanFactory beanFactory , CustomFieldValueManager customFieldValueManager) {
	...
	private boolean stringValueExists(ApplicationUser searcher, String fieldName, String stringValue) {
		List<ExecutionCf> executionsCfList = customFieldValueManager.checkCustomFieldValueExistByTypeAndKey(ApplicationConstants.STRING_VALUE, stringValue, null);
